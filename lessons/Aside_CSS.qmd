...
```{r}
#| label: CSS_rule_conflict_example
#| eval: false
/* All Slider Labels */
...
- All slider labels except `slider_1` will have `orange` text.
- The label for `slider_1` will have `blue` text.
- All slider labels, including `slider_1`, will have a `red` background, because the ID selector does not override that property.
